...
/* Standard loading glyph (Element Plus is-loading rotation) inside the busy start button. */
.row-spinner {
  font-size: 12px;
  line-height: 1;
}
...
/* Damped when 减少动效 is in effect (see stores/settings.applyReduceMotion).
   EP's is-loading spins at 2s/turn — slow it further (not 1.6s, which would speed it up). */
html.reduce-motion .row-spinner {
